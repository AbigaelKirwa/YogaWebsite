...
const Footer = () => {
  return (
    <footer class="mt-24 px-10 py-10 bg-[#F0DFCE] flex max-[980px]:flex-col">
        <div class="w-4/5 grid grid-cols-3 gap-10 max-[980px]:flex max-[980px]:w-full max-[980px]:justify-center max-[980px]:items-center max-md:w-full max-sm:grid max-sm:grid-cols-1 max-sm:gap-10">
