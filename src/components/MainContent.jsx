...
function MainContent(){
  return(
    <div id='main-overall' className='flex flex-row justify-between max-[841px]:flex-col-reverse'>
        <div id="words" className='mt-16 ml-10 w-2/3 max-[1039px]:w-full max-[841px]:ml-0 max-[841px]:px-10 max-[841px]:mt-10'>
            ...
            In our nurturing environment, experienced instructors will guide you through poses that cultivate strength, flexibility, and mindfulness. Join our community and embark on a journey towards holistic wellness, fitness, and a balanced mind-body-spirit connection.
            </p>
        ...
        <div id="main-pic" className='mt-[-40px] flex justify-center max-[1130px]:mt-[-35px] max-[1076px]:mt-[10px] max-[1039px]:mt-[10px] max-[975px]:mt-[40px] max-[841px]:ml-0 max-[841px]:mt-0'>
            <img src={MainImg} alt="website main"  className='w-[70%] max-[1000px]:w-[100%] max-[841px]:w-[50%] max-[500px]:w-[70%]'/>
        </div>
    </div>
  )
}
